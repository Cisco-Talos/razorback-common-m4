...
# This file provides the macros to work with rzb_visibility.h provided by the razorback_utils library.
...
[
    ...
    AC_CACHE_VAL(gl_cv_cc_visibility, [
        ...
        # but only warn about it instead of compilation failing, This is done in
        # compiler_options.m4
